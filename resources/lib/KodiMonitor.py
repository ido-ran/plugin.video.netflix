...
from resources.lib.KodiHelper import TAGGED_WINDOW_ID, \
    PROP_NETFLIX_PLAY, PROP_PLAYBACK_INIT
...
class KodiMonitor(xbmc.Monitor):
    ...
    def _on_playback_started(self, item):
        ...
        if player_id is not None and self.is_initialized_playback():
            ...
            self.progress = 0
            xbmcgui.Window(self.nx_common.TAGGED_WINDOW_ID).setProperty(
                self.nx_common.PROP_NETFLIX_PLAY,
            ...
            xbmcgui.Window(self.nx_common.TAGGED_WINDOW_ID).setProperty(
                self.nx_common.PROP_NETFLIX_PLAY, 'notnetflix')
    ...
    def _on_playback_stopped(self):
        ...
        xbmcgui.Window(self.nx_common.TAGGED_WINDOW_ID).setProperty(
            self.nx_common.PROP_NETFLIX_PLAY, 'stopped')
        self.video_info = None
        self.progress = 0
